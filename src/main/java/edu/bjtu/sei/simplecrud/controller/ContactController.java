...
public class ContactController {
    ...
    @GetMapping(value = "/contacts/{contactId}")    //用大括号括起来表示该处为具体值
    public String getContactById(Model model, @PathVariable long contactId) {
        //Model是controller里的一个成员
        ...
        return "contact";
        //返回的都是view name视图名，在templates中对应
    }
    ...
    public String addContact(Model model,
            //model可以接受view前端传来的值，将值序列化到对象Contact的实例contact中
